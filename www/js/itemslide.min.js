! function a(b, c, d) {
    ...
    1: [function(a, b) {
        (function(a) {
            var c = function(a) {
                function b(a) {
                    l.children(":nth-child(" + (j.currentIndex + 1 || 0) + ")").removeClass("itemslide-active").find(".cen").hide(), l.children(":nth-child(" + (a + 1 || 0) + ")").addClass("itemslide-active").find(".cen").show(), a != k.currentIndex && (j.currentIndex = a, l.trigger("changeActiveIndex"))
                }
    ...
    8: [function(a, b) {
        function c(a) {
            function b() {
                ...
                return 1 == q && ($(".itemslide_slideoutwrap").children().unwrap(), e.savedSlideIndex == g.currentIndex && $(s).children(":nth-child(1)").addClass("itemslide-active").find(".cen").show(), e.savedSlideIndex != e.children().length - 1 || r || e.savedSlideIndex != g.currentIndex || (f.duration = 200, a.anim.gotoSlideByIndex(e.children().length - 2)), 0 == e.savedSlideIndex && 0 != g.currentIndex && (p = 500), q = -1), p >= 250 && (o = !1, -1 != q && (q = 1), p >= 375) ? ($(s).children().unwrap(), e.removeSlide(c.index()), (0 == e.savedSlideIndex && 0 != g.currentIndex || r) && a.anim.gotoSlideByIndex(g.currentIndex - 1, !0), f.duration = l, p = 0, void(e.end_animation = !0)) : void(k = requestAnimationFrame(b))
            }
            var c, d, e = a.$el,
                f = a.options,
                g = a.vars,
