(function($){
  $.fn.pull_to_refresh = function(options) {
    ...
    var defaults = {
      ...
      pull_to_refresh_text: 'Empuja para actualizar...',
      letgo_text: 'Suelta para actualizar...',
      refreshing_text: 'Actualizando..',
    ...
    document.getElementById(options.status_indicator_id).addEventListener('touchstart', function(e) {
      try {
    ...
    // start the callback
    document.getElementById(options.status_indicator_id).addEventListener('touchend', function(e) {
      if(refresh) {
    ...
    document.getElementById(options.status_indicator_id).addEventListener('touchmove', function(e) {
